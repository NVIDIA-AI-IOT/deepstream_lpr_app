...
echo "prepare US_LPD"
mkdir -p triton_models/US_LPD/1/
./tao-converter -k nvidia_tlt  -t int8 -c  models/LP/LPD/usa_lpd_cal.bin -e triton_models/US_LPD/1/usa_pruned.etlt_b16_gpu0_int8.engine -b 16 -d 3,480,640 models/LP/LPD/usa_pruned.etlt
cp models/LP/LPD/usa_lpd_label.txt triton_models/US_LPD/

echo "prepare us yolov4-tiny"
mkdir -p triton_models/us_lpd_yolov4-tiny/1/
./tao-converter -k nvidia_tlt -t int8 -c models/tao_pretrained_models/yolov4-tiny/yolov4_tiny_usa_cal.bin -e triton_models/us_lpd_yolov4-tiny/1/yolov4_tiny_usa_deployable.etlt_b16_gpu0_int8.engine -b 16 -p Input,1x3x480x640,8x3x480x640,16x3x480x640 models/tao_pretrained_models/yolov4-tiny/yolov4_tiny_usa_deployable.etlt 
cp models/tao_pretrained_models/yolov4-tiny/usa_lpd_label.txt triton_models/us_lpd_yolov4-tiny

echo "prepare us_lprnet"
mkdir -p triton_models/us_lprnet/1/
./tao-converter -k nvidia_tlt -t fp16 -e triton_models/us_lprnet/1/us_lprnet_baseline18_deployable.etlt_b16_gpu0_fp16.engine -p image_input,1x3x48x96,8x3x48x96,16x3x48x96 models/LP/LPR/us_lprnet_baseline18_deployable.etlt
